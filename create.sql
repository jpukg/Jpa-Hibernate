...
create table Employee (id number(10,0) not null, firstName varchar2(255 char) not null, version integer DEFAULT 0 not null, empDetails_id number(10,0), primary key (id))
