...
2. the type-restricted mode:  every attributes of a class are reference to respective type field that give compile time access  by metamodel class.JPA standard metamodel should be entityname_ 

Create Employee_.java
```
package com.javaaround.model;
...
that are to be generated by the JPA provider automatically

Add Annotation Processsor at pom.xml && dependency
...
Generate Employee_.java looks like 
